...
SemT-X supports compliance with data governance (DGA), data protection (GDPR), and data-sharing regulations (Data Act) by enriching datasets with machine-readable semantic annotations that enable the identification of data categories, usage restrictions, and interoperability requirements, which can subsequently be leveraged by policy and compliance assessment tools. Moreover, the generated annotations and provenance information support dataset documentation, the identification of sensitive data categories, and the traceability of data transformations, thereby contributing to the data governance and technical documentation activities required under the AI Act.
